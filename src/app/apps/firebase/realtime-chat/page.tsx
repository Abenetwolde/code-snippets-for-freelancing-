...
export default function FirebasePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Firebase Realtime Chat</h1>
      {user ? (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <p className="text-lg">Welcome, {user.email}! {isAdmin && "(Admin)"}</p>
            <button
        ...
        <div className="space-y-4">
          <p className="text-lg">Please log in to join the chat.</p>
